...
const programs = [
  ...
  },
  {
    ...
    iconColor: 'from-purple-500 to-indigo-500 bg-purple-500',
    ...
    advantages: [
      ...
      'Musiqa oʻqituvchilari va oʻquvchilar uchun mashq jarayonini yengillashtirish.'
    ],
...
fs.writeFileSync(path.join(__dirname, 'programs_list.json'), JSON.stringify(programs, null, 2), 'utf-8');
console.log('Built programs_list.json!');
