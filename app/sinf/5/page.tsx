...
import { Music, FileDown, BookOpen, Layers, Award, ShieldAlert, Heart, Play, ChevronDown, CheckCircle } from 'lucide-react';
...
export default function GradePage() {
  ...
  const [activeMidi, setActiveMidi] = useState<MidiPiece | null>(null);
  ...
  const handleDownload = (piece: MidiPiece) => {
    // Record download statistics via API call
    fetch('/api/stats', {
      method: 'POST',
